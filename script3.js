...
async function verDatos () {
    const data = await obtenerDatos('https://rickandmortyapi.com/api/character/?page=5');
    const data2 = await obtenerDatos('https://rickandmortyapi.com/api/character/?page=6');
